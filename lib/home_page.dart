...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.grey.shade50, // Temiz arka plan
      body: SafeArea(
        child: SingleChildScrollView(
          padding: const EdgeInsets.all(24.0), // Dengeli kenar boşluğu
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              // --- 1. ÜST ALAN: HOŞ GELDİN PANELİ & ÇIKEŞ ---
              Row(
                ...
                children: [
                  ...
                  IconButton(
                    ...
                    tooltip: 'Çıkış Yap',
                    onPressed: () {
                      // Çıkış yapıldığında kullanıcıyı tekrar giriş ekranına geri fırlatır
                      Navigator.pushReplacementNamed(context, '/'); 
                      // Not: Eğer isimlendirilmiş rota kullanmıyorsan dün yaptığımız gibi 
                      // MaterialPageRoute ile MyHomePage'e yönlendirebilirsin.
                    },
                  ),
                ],
              ),
              ...
              // --- 4. MODÜLER AKSİYON KARTLARI (DOKÜMANDAKİ 3 TEMEL YAPI) ---
              ...
              _buildMenuCard(
                ...
                onTap: () {
                  ...
                  // Yarın buraya ChatPage() bağlayacağız 
                  Navigator.push(
                    context,
              ...
              _buildMenuCard(
                ...
                onTap: () {
                  ...
                  // İleride buraya PhotoSolutionPage() bağlayacağız
                },
              ),
              const SizedBox(height: 16),
              ...
              _buildMenuCard(
                ...
                onTap: () {
                  ...
                  // İleride buraya CommunityPage() bağlayacağız
                },
              ),
            ],
          ),
  ...
  // Yeniden Kullanılabilir (Re-usable) Şık Kart Tasarımı (Widgets İlkesi)
